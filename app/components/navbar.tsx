            ...
            {isMenuOpen && (
                <div className="w-full bg-[#1a3838] lg:hidden shadow-2xl border-t border-white/5">
                    <ul className="flex flex-col py-6">
                        <li><Link href="/" className="px-8 py-4 block hover:bg-[#244d4d] hover:text-[#a58d71] transition-colors text-white font-medium border-b border-white/5">Home</Link></li>
                        <li><Link href="/products" className="px-8 py-4 block hover:bg-[#244d4d] hover:text-[#a58d71] transition-colors text-white font-medium border-b border-white/5">Products</Link></li>
                        <li><Link href="/contact" className="px-8 py-4 block hover:bg-[#244d4d] hover:text-[#a58d71] transition-colors text-white font-medium">Contact</Link></li>
                    </ul>
                </div>
            )}
